...
def run_test():
    try:
        print("Simulating double click on ModernToggle...")
        QTest.mouseClick(window.start_btn, Qt.MouseButton.LeftButton)
        # 100ms later, click again to simulate user getting impatient
        QTimer.singleShot(100, lambda: QTest.mouseClick(window.start_btn, Qt.MouseButton.LeftButton))
